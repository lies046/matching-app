...
ActiveRecord::Schema.define(version: 2020_06_28_022301) do
  ...
  create_table "conversations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
